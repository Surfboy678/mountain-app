package com.mountainapp.commons.extras;
...
public class CreatorXLS<T> {
    ...
    public void creataFile(List<T> series,String path, String fileName  ) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, IOException {
